...
/**
 ...
 @discussion You need to pass `NSInteger` as a parameter.
 */
-(InsiderUser*(^)(NSInteger))setAge;

/**
 This method allows you to set email attribute of your InsiderUser object.
 @discussion You need to pass a `NSString` object as a parameter.
 */
-(InsiderUser *(^)(NSString *))setEmail;

/**
 This method allows you to set phone number attribute of your InsiderUser object.
 @discussion You need to pass a `NSString` object as a parameter.
 */
...
/**
 ...
 @warning If you pass `NO` to this method, that device wont be able to receive push notifications until it set back to `YES`.
 */
...
/**
 ...
 @warning If you pass `NO` to this method, Insider Geofencing will stop working until it set back to `YES`.
 */
...
/**
 ...
 @warning If you pass `NO` to this method, WhatsApp Service will stop working until it set back to `YES`.
 */
...
/**
 This method allows you set a `NSInteger` type attribute to your InsiderUser object.
 @discussion The first parameter is the key and the second parameter is the value of the attribute that is going to be added to the InsiderUser object.
 
 @warning Your attribute key should be all lowercase and should not include any special or non Latin characters, otherwise this attribute will be ignored. For more information check our documentation.
 */
-(InsiderUser*(^)(NSString *, NSInteger))setCustomAttributeWithInt;
