 ...
 */
-(InsiderProduct*(^)(NSInteger))setStock;
 ...
 */
-(InsiderProduct*(^)(NSInteger))setQuantity;
...
/**
 This method allows you to set the brand attribute of your InsiderProduct object.
 */
-(InsiderProduct *(^)(NSString *))setBrand;

/**
 This method allows you to set the gender attribute of your InsiderProduct object.
 */
-(InsiderProduct *(^)(NSString *))setGender;

/**
 This method allows you to set the sku attribute of your InsiderProduct object.
 */
-(InsiderProduct *(^)(NSString *))setSku;

/**
 This method allows you to set the multipack attribute of your InsiderProduct object.
 */
-(InsiderProduct *(^)(NSString *))setMultipack;

/**
 This method allows you to set the productType attribute of your InsiderProduct object.
 */
-(InsiderProduct *(^)(NSString *))setProductType;

/**
 This method allows you to set the gtin attribute of your InsiderProduct object.
 */
-(InsiderProduct *(^)(NSString *))setGtin;

/**
 This method allows you to set the description attribute of your InsiderProduct object.
 */
-(InsiderProduct *(^)(NSString *))setDescription;

/**
 This method allows you to set the tags attribute of your InsiderProduct object.
 */
...
/**
 This method allows you set a `NSInteger` type attribute to your InsiderProduct object.
 @discussion The first parameter is the key and the second parameter is the value of the attribute that is going to be added to the InsiderProduct object.
 
 @warning Your attribute key should be all lowercase and should not include any special or non Latin characters, otherwise this attribute will be ignored. For more information check our documentation.
 */
-(InsiderProduct*(^)(NSString *, NSInteger))setCustomAttributeWithInt;
...
/**
 ...
 @warning Your attribute key should be all lowercase and should not include any special or non Latin characters, otherwise this attribute will be ignored. For more information check our documentation.
 */
-(InsiderProduct*(^)(NSString *, NSArray *))setCustomAttributeWithArray __attribute__((deprecated("Use 'setCustomAttributeWithStringArray' instead.")));

/**
 This method allows you set a NSArray with NSString type attribute to your InsiderProduct object.
 @discussion The first parameter is the key and the second parameter is the value of the attribute that is going to be added to the InsiderProduct object.
...
/**
 This method allows you set a NSArray with numeric type attribute to your InsiderProduct object.
 @discussion The first parameter is the key and the second parameter is the value of the attribute that is going to be added to the InsiderProduct object.
...
/**
 This method will return the groupcode of the InsiderProduct object.
 @return GroupCode of the InsiderProduct object.
 */
-(NSString *)getGroupCode;
...
/**
 This method will return the tags of the InsiderProduct object.
 @return Tags of the InsiderProduct object.
 */
...
This method will return the string customAttribute of the InsiderProduct object.
 ...
 @return `NSInteger` customAttribute of the InsiderProduct object for the given key..
*/
-(NSInteger)getCustomAttributeInt:(NSString *)key;
...
*/
-(NSArray *)getCustomAttributeArray:(NSString *)key __attribute__((deprecated("Use 'getCustomAttributeStringArray' instead.")));

/**
This method will return the string array customAttribute of the InsiderProduct object.
 @param key The key of the customAttribute.

 @return `NSArray<NSString *>` customAttribute of the InsiderProduct object for the given key..
*/
-(NSArray<NSString *> *)getCustomAttributeStringArray:(NSString *)key;

/**
This method will return the numeric array customAttribute of the InsiderProduct object.
 @param key The key of the customAttribute.

 @return `NSArray<NSNumber *>` customAttribute of the InsiderProduct object for the given key..
*/
-(NSArray<NSNumber *> *)getCustomAttributeNumericArray:(NSString *)key;
